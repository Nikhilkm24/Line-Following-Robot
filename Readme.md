...
![Custom Fabricated PCB](hardware/pcb_photo.jpeg)
...
Schematic designed in **KiCad 8.0.7** — see `hardware/lfr_schematic.png`:
 
![LFR Schematic](hardware/lfr_schematic.png)
...
└── hardware/
    ...
    ├── lfr_schematic.png      ← KiCad schematic (exported)
    ├── lfr.pdf                ← Full schematic PDF
